...
/**
 * Inline SVG icon set for the adaptive shell — 24px grid, 1.5 stroke,
 * round caps/joins (the Facilio Atom line style). `currentColor` throughout
 * so nav states recolor them for free.
 */
...
/** The 3D estate. Same isometric cube the detail card uses for an asset. */
